...
class SnakeGame:
    ...
    def draw_border(self):
        self.canvas.create_rectangle(0, 0, WIDTH, HEIGHT, outline="white", width=2)
    ...
    def toggle_pause(self, event=None):
        ...
        if self.paused:
            self.canvas.create_text(WIDTH // 2, HEIGHT // 2, text="Pause", fill="yellow", font=("Arial", 20),
                                    tag="pause")
        else:
    ...
    def move_snake(self):
        ...
        if new_head in self.snake or new_head[0] < 0 or new_head[1] < 0 or new_head[0] >= WIDTH // CELL_SIZE or \
